  ...
  actions: {
    ...
    async fetchRole({ commit }, id) {
      try {
        ...
        commit('SET_ERROR', error.message || 'Failed to fetch role')
        throw error
      } finally {
        commit('SET_LOADING', false)
      }
    ...
    async createRole({ commit }, roleData) {
      try {
        ...
        commit('SET_ERROR', error.message || 'Failed to create role')
        throw error
      } finally {
        commit('SET_LOADING', false)
      }
    ...
    async updateRole({ commit }, { id, roleData }) {
      try {
        ...
        commit('SET_ERROR', error.message || 'Failed to update role')
        throw error
      } finally {
        commit('SET_LOADING', false)
      }
    ...
    async deleteRole({ commit }, id) {
      try {
        ...
        commit('SET_ERROR', error.message || 'Failed to delete role')
        throw error
      } finally {
        commit('SET_LOADING', false)
      }
